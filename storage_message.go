...
//主从同步消息
const (
	MSG_STORAGE_SYNC_BEGIN         = 220
	MSG_STORAGE_SYNC_MESSAGE       = 221
	MSG_STORAGE_SYNC_MESSAGE_BATCH = 222

	//内部文件存储使用
	//超级群消息队列 代替MSG_GROUP_IM_LIST
	MSG_GROUP_OFFLINE = 247
	...
	//im实例使用
	MSG_PENDING_GROUP_MESSAGE = 251

	//超级群消息队列
	//deprecated 兼容性
	MSG_GROUP_IM_LIST = 252

	//deprecated
	MSG_GROUP_ACK_IN = 253
